...
runfile = os.path.join(dir, 'brazil_samples_v6.csv')
mtg = os.path.join(dir, 'metadata', 'reptile_mitogenomes.fa')
mira_dir = '/home/sosi/bin/mira_4.0.2_linux-gnu_x86_64_static/bin/'
...
def run_mira(outdir, conf):
	os.chdir(outdir)
	subprocess.call('%s%s %s' % (mira_dir, 'mira', conf), shell=True)
